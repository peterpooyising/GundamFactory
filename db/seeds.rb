...
# ========================= New Models ========================================
Product.create(name: 'Blaze Zaku Phantom', category_ids: 2, brand_id: 6, cost_price: 35 , selling_price: 38, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/NFYWA5gjSMauIGXYLafc', position: 1}], description: 'Blaze Zaku Phantom' )

Product.create(name: 'MS-06 Zaku II', category_ids: 2, brand_id: 2, cost_price: 30 , selling_price: 38, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/mCO7JIgOR3KhglcKzhM4', position: 1}], description: 'MS-06 Zaku II' )

Product.create(name: 'RX-0 Unicorn Gundam', category_ids: 1, brand_id: 3, cost_price: 15 , selling_price: 45, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/T8tPSQpQRkWjitPlqyR6', position: 1}], description: 'RX-0 Unicorn Gundam' )

Product.create(name: 'MBF-P02 Astray Red Frame Gundam', category_ids: 1, brand_id: 4, cost_price: 19, selling_price: 40, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/7web7VaSR4WEfjHsdGv3', position: 1}], description: 'MBF-P02 Astray Red Frame Gundam' )

# ========================== Popular Models =================================
Product.create(name: 'Black Tri-Stars Zaku II Hi Maneuver Type', category_ids: 2, brand_id: 2, cost_price: 37 , selling_price: 38, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/AeiBBnFQMOoHEdx5Yupc', position: 1}], description: 'Black Tri-Stars Zaku II Hi Maneuver Type' )

Product.create(name: 'GX-9901-DX Double X Gundam', category_ids: 1, brand_id: 5, cost_price: 8, selling_price: 37, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/EqvDFSnURWidRPgmnoaf', position: 1}], description: 'GX-9901-DX Double X Gundam' )

Product.create(name: 'GX-9900 X Devil Gundam', category_ids: 1, brand_id: 5, cost_price: 20, selling_price: 49, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/vQKHzBg3Q6GPAxsOdq1r', position: 1}], description: 'GX-9900 X Devil Gundam' )

Product.create(name: 'ZGMF-X666S Legend Gundam', category_ids: 1, brand_id: 6, cost_price: 15, selling_price: 55, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/rwMA2Ni1SUqGdQ9BvmoA', position: 1}], description: "ZGMF-X666S Legend Gundam" )

# ======================== Not shown ========================================
Product.create(name: 'RX-93 V GUNDAM', category_ids: 1, brand_id: 7, cost_price: 8, selling_price: 51, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/wvy8tlMYQwuHz1mt2r2Z', position: 1}], description: 'RX-93 V GUNDAM' )

Product.create(name: 'PF-73-3BL Lightning Warrior Gundam', category_ids: 1, brand_id: 1, cost_price: 3 , selling_price: 32, stock: 10, images_attributes: [{url: 'https://cdn.filestackcontent.com/RWFjZKZCR6Cn5F2aAhiu', position: 1}], description: 'PF-73-3BL Lightning Warrior Gundam')


# ===================================== Seed File with Original URL ====================================================
